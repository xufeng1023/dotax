...
class HomeController extends Controller
{
    ...
    function generate8843()
    {
        $data = [
            ...
            'topmostSubform[0].Page1[0].f1_15[0]' => request('form8843.yearDays')[date('Y')],
            'topmostSubform[0].Page1[0].f1_16[0]' => request('form8843.yearDays')[date('Y') - 1],
            'topmostSubform[0].Page1[0].f1_17[0]' => request('form8843.yearDays')[date('Y') - 2],
