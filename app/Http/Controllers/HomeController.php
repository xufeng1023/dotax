...
class HomeController extends Controller
{
    ...
    function generate8843()
    {
        $data = [
            ...
            'topmostSubform[0].Page1[0].f1_25[0]' => isset(request('form8843.yearDays')[date('Y')-5])? request('form8843.yearDays')[date('Y')-5]['type'] : 0,
            ...
            'topmostSubform[0].Page1[0].f1_30[0]' => isset(request('form8843.yearDays')[date('Y')])? request('form8843.yearDays')[date('Y')]['type'] : 0,
