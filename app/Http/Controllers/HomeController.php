...
class HomeController extends Controller
{
    ...
    function generate8843()
    {
        $data = [
            ...
            'topmostSubform[0].Page2[0].f2_10[0]' => request('form8843.typeData.individual.date1'),
            'topmostSubform[0].Page2[0].f2_11[0]' => request('form8843.typeData.individual.date2'),
