...
class HomeController extends Controller
{
    ...
    function generate8843()
    {
        $data = [
            ...
            'topmostSubform[0].Page1[0].f1_18[0]' => request('form8843.yearDays')[date('Y')] ?? 0,
            'topmostSubform[0].Page1[0].f1_19[0]' => request('form8843.teacher.name').', '.request('form8843.teacher.address').', '.request('form8843.teacher.phone'),
            'topmostSubform[0].Page1[0].f1_20[0]' => request('form8843.trainee.name').', '.request('form8843.trainee.address').', '.request('form8843.trainee.phone'),
