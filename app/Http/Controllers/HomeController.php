...
class HomeController extends Controller
{
    ...
    function generate8843()
    {
        $data = [
            ...
            'topmostSubform[0].Page1[0].f1_25[0]' => isset(request('form8843.yearDays')[date('Y')-6])? request('form8843.yearDays')[date('Y')-5]['type'] : '',
            'topmostSubform[0].Page1[0].f1_26[0]' => isset(request('form8843.yearDays')[date('Y')-5])? request('form8843.yearDays')[date('Y')-4]['type'] : '',
            'topmostSubform[0].Page1[0].f1_27[0]' => isset(request('form8843.yearDays')[date('Y')-4])? request('form8843.yearDays')[date('Y')-3]['type'] : '',
            'topmostSubform[0].Page1[0].f1_28[0]' => isset(request('form8843.yearDays')[date('Y')-3])? request('form8843.yearDays')[date('Y')-2]['type'] : '',
            'topmostSubform[0].Page1[0].f1_29[0]' => isset(request('form8843.yearDays')[date('Y')-2])? request('form8843.yearDays')[date('Y')-1]['type'] : '',
            'topmostSubform[0].Page1[0].f1_30[0]' => isset(request('form8843.yearDays')[date('Y')-1])? request('form8843.yearDays')[date('Y')]['type'] : '',
