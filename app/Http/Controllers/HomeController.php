...
class HomeController extends Controller
{
    ...
    function generate8843()
    {
        ...
        if(request('form8843.type') == 'student') {
            ...
            $data['topmostSubform[0].Page1[0].f1_39[0]'] = isset(request('form8843.yearDays')[date('Y')-4])? strtoupper(request('form8843.yearDays')[date('Y')-3]['type']) : '';
            $data['topmostSubform[0].Page1[0].f1_40[0]'] = isset(request('form8843.yearDays')[date('Y')-3])? strtoupper(request('form8843.yearDays')[date('Y')-2]['type']) : '';
            $data['topmostSubform[0].Page1[0].f1_41[0]'] = isset(request('form8843.yearDays')[date('Y')-2])? strtoupper(request('form8843.yearDays')[date('Y')-1]['type']) : '';
            $data['topmostSubform[0].Page1[0].f1_42[0]'] = isset(request('form8843.yearDays')[date('Y')-1])? strtoupper(request('form8843.yearDays')[date('Y')]['type']) : '';
